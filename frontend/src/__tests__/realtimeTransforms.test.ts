...
describe('formatPhaseLabel and formatScenarioLabel', () => {
  ...
  it('formats scenario IDs to friendly human readable labels', () => {
    ...
    expect(formatScenarioLabel('peak')).toBe('Peak')
    expect(formatScenarioLabel('oversaturated')).toBe('Oversaturated')
    expect(formatScenarioLabel('rain')).toBe('Rain')
    expect(formatScenarioLabel('incident')).toBe('Incident')
    expect(formatScenarioLabel('heavy_traffic')).toBe('Peak')
    expect(formatScenarioLabel('morning_peak')).toBe('Peak')
